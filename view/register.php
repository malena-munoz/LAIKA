        ...
        <div id="form-body">
            ...
            <div id="input-area">
                ...
                <div class="form-inp" id="claveRepetida-inp" style="display: none;">
                    <input type="password" id="claveRepetida" name="claveRepetida" placeholder="Repite la contraseña">
                </div>
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    ...
                    if (response === "disponible") {
                        ...
                        xhrInsert.open("POST", "./view/insertar_usuario.php", true);
                        ...
                        xhrInsert.onreadystatechange = function() {
                            if (xhrInsert.readyState === XMLHttpRequest.DONE) {
                                if (xhrInsert.status === 200) {
                                    ...
                                    xhrInsertNota.open("POST", "./view/insertar_nota.php", true);
                                    ...
                                    xhrInsertNota.onreadystatechange = function() {
                                        if (xhrInsertNota.readyState === XMLHttpRequest.DONE) {
                                            if (xhrInsertNota.status === 200) {
                                                ...
                                                var nombreUsuario = document.getElementById("nombre").value;
                                                document.getElementById("welcome-user").textContent = "Bienvenido " + nombreUsuario;
